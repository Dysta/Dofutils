...
class TestXorCipher(TestCase):
    ...
    def test_encrypt(self):
        ...
        self.assertEqual("251C4C070A593A16520701594C", cipher.encrypt("Hello World !", 0))
        self.assertEqual("251C4C070A59271648054558", cipher.encrypt("Hello John !", 0))
        self.assertEqual("271104091D003C0A0B03104844", XorCipher("other key").encrypt("Hello World !", 0))
    ...
    def test_decrypt(self):
        ...
        self.assertEqual("Hello World !", cipher.decrypt("251C4C070A593A16520701594C", 0))
        self.assertEqual("Hello John !", cipher.decrypt("251C4C070A59271648054558", 0))

        self.assertNotEqual("Hello World !", XorCipher("other key").decrypt("251C4C070A593A16520701594C", 0))
